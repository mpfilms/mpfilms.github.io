...
export class App implements OnInit, AfterViewInit {
  ...
  public activeBranch: string = 'all';

  protected readonly title = signal('mpfilms');

  // Diccionario de traducciones completo (EN por defecto + ES y DE)
  private readonly translations: { [key: string]: PageTexts } = {
    en: {
      nav_home: "Home", nav_exp: "Experience", nav_about: "My Vision", nav_packs: "Investment", nav_contact: "Contact",
      hero_sub: "Swiss Cinematic Legacy & Commercial Studio", hero_tag: "Where the unseen becomes unforgettable",
      btn_bodas: "WEDDINGS", btn_studio: "STUDIO",
    ...
    es: {
      nav_home: "Inicio", nav_exp: "Experiencia", nav_about: "Mi Visión", nav_packs: "Inversión", nav_contact: "Contacto",
      hero_sub: "Cinematografía de Bodas & Estudio Comercial", hero_tag: "Donde lo invisible se vuelve inolvidable",
      btn_bodas: "BODAS", btn_studio: "STUDIO",
    ...
    de: {
      nav_home: "Startseite", nav_exp: "Portfolio", nav_about: "Meine Vision", nav_packs: "Investment", nav_contact: "Kontakt",
      hero_sub: "Hochzeitsvideografie & Commercial Studio", hero_tag: "Wo das Unsichtbare unvergesslich wird",
      btn_bodas: "HOCHZEITEN", btn_studio: "STUDIO",
  ...
  ngAfterViewInit() {
    if (isPlatformBrowser(this.platformId)) {
      // Carga automáticamente en inglés ('en') si no hay selección previa
